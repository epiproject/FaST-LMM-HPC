...
import sys
import doctest
from fastlmmhpc.util.runner import Local, Hadoop, Hadoop2, HPC, LocalMultiProc, LocalInParts, LocalFromRanges, LocalMapper, LocalReducer
from fastlmmhpc.util.distributabletest import DistributableTest


from fastlmmhpc.util.distributed_map import d_map
from fastlmmhpc.util.distributed_map import dummy
...
if __name__ == '__main__':
    ...
    import fastlmmhpc.util.testdistributable
