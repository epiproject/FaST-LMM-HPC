...
from fastlmmhpc.util.runner import Local, Hadoop, Hadoop2, HPC, LocalMultiProc, LocalInParts
...
if __name__ == '__main__': 
    ...
    from fastlmmhpc.association.tests.testepistasis import TestEpistasis
