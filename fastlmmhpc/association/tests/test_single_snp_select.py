...
from fastlmmhpc.association import single_snp_select
from fastlmmhpc.association.tests.test_single_snp_all_plus_select import mf_to_runner_function
...
class TestSingleSnpSelect(unittest.TestCase): 
    ...
    def test_old_sel_plus_pc(self): #!!! rather a big test case
        ...
        # import algorithms
        from fastlmmhpc.util.run_fastlmmc import runFASTLMM, runLMMSELECT
...
if __name__ == '__main__':
    ...
    from fastlmmhpc.association.tests.test_single_snp_select import TestSingleSnpSelect
