...
#from fastlmmhpc.association.gwas import LeaveOneChromosomeOut, LocoGwas, FastGwas, load_intersect
from fastlmmhpc.association.LeaveOneChromosomeOut import LeaveOneChromosomeOut
from fastlmmhpc.association.PrecomputeLocoPcs import load_intersect
from fastlmmhpc.association.LocoGwas import FastGwas, LocoGwas
from fastlmmhpc.util import run_fastlmmc
...
class TestGwas(unittest.TestCase):
    ...
    def test_results_identical_with_fastlmmc(self):
        ...
        from fastlmmhpc.association.single_snp import single_snp
