...
from fastlmmhpc.association.heritability_spatial_correction import heritability_spatial_correction
...
if __name__ == '__main__':
    ...
    #from fastlmmhpc.association.tests.test_heritability_spatical_correction import TestHeritabilitySpatialCorrection
