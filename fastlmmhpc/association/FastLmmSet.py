import fastlmmhpc.association.lrt as lr
import fastlmmhpc.association.score as score
import fastlmmhpc.association.testCV as testCV
import fastlmmhpc.inference as fastlmm
from fastlmmhpc.pyplink.plink import *
from pysnptools.util.pheno import *
from fastlmmhpc.pyplink.altset_list import *
import subprocess, sys, os.path
import fastlmmhpc.util.stats.chi2mixture as c2
from fastlmmhpc.util.distributable import *
from fastlmmhpc.util.runner import *
import pdb
import fastlmmhpc.util.util as utilx
import fastlmmhpc.util.stats as ss
import time
from Result import *
from PairResult import *
from fastlmmhpc.association.tests import *
import fastlmmhpc.util.genphen as gp
import scipy as sp
from itertools import *
from fastlmmhpc.pyplink.snpreader.Bed import *
import logging
import warnings
...
class FastLmmSet: # implements IDistributable
    ...
    def getRandSnpSignal(self, nSnp, nInd,genphen,newseed):
        from numpy.random import RandomState
        import fastlmmhpc.util.gensnp as gp
        randomstate = RandomState(newseed) 
    ...
    def pv_from_localperm(self, iperm, result, t0, varcomp_test, y):
        ...
        if self.fitlocal and pv*pm<10**powerneeded:
            import fastlmmhpc.association.tests.Cv as cv
...
if __name__ == "__main__":
    ...
    from fastlmmhpc.association.FastLmmSet import *
