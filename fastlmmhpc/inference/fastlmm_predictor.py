...
from fastlmmhpc.inference.lmm import LMM
...
class FastLMM(object):
    ...
    **Constructor:**
    ...
    def fit(self, X=None, y=None, K0_train=None, K1_train=None, h2=None, mixing=None):
        ...
        from fastlmmhpc.association.single_snp import _set_block_size
        ...
        from fastlmmhpc.association.single_snp import _Mixer #!!!move _combine_the_best_way to another file (e.g. this one)
